...
export default function SkillsSection() {
  return (
    <>
      ...
      <SkillsSubsection title="Frontend" IconComponent={RiImageEditFill} marginTop="mt-8">
        <Skill IconComponent={FaHtml5} text="HTML" />
        <Skill IconComponent={FaCss3Alt} text="CSS" />
        <Skill IconComponent={FaReact} text="React" />
        <Skill IconComponent={SiTailwindcss} text="TailwindCSS" />
      </SkillsSubsection>

      <SkillsSubsection title="Backend" IconComponent={FaServer} marginTop="mt-8">
        <Skill IconComponent={FaNodeJs} text="Node.js" />
        <Skill IconComponent={FaReact} text="Express.js" />
      </SkillsSubsection>

      <SkillsSubsection title="Database" IconComponent={FaDatabase} marginTop="mt-8">
        <Skill IconComponent={SiMongodb} text="MongoDB" />
      </SkillsSubsection>

      <SkillsSubsection title="Miscellaneous" IconComponent={MdMiscellaneousServices} marginTop="mt-8">
        <Skill IconComponent={FaGitAlt} text="Git" />
        <Skill IconComponent={FaGithub} text="GitHub" />
        <Skill IconComponent={SiCloudinary} text="Cloudinary" />
      </SkillsSubsection>
    </>
  );
}
