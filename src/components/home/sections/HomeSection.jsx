  ...
  return (
    <>
       {/* <section
        ...
        id="home"
        className="before:bg-grey-transparent-dark before:absolute before:inset-0 before:z-0 relative h-screen text-white bg-white bg-Anmol  bg-contain bg-no-repeat bg-bottom font-roboto sm:bg-right-bottom lg:before:bg-grey-transparent"> */}
  <section
  ref={sectionsRefs['home']}
  id="home"
  style={{ backgroundImage: 'url(/images/anmol.jpg)', backgroundSize: 'contain', backgroundPosition: '85% bottom', backgroundRepeat: 'no-repeat' }}
  className="before:bg-grey-transparent before:absolute before:inset-0 before:z-0 relative h-screen text-white bg-white font-roboto lg:before:bg-grey-transparent">
        ...
        <div className="relative flex flex-col justify-center text-center h-full z-10 lg:w-8/12 xl:w-9/12">
          ...
          <h1 className="text-5xl font-bold mb-8 sm:text-6xl xl:text-7xl">Anmol Bohare</h1>
